...
export const ReveiwListPage = () => {
    ...
    const indexofFirstReveiw : number = indexOfLastReview - reviewsPerPage;
    ...
    return(
        <div className="container m-5">
            ...
            <p>
                {indexofFirstReveiw + 1} to {lastItem} of {totalAmountOfReviews} items:
            </p>
            <div className="row">
                {reviews.map(review => (
