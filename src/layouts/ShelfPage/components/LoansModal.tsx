...
export const LoansModal: React.FC<{ shelfCurrentLoan: ShelfCurrentLoans, mobile: boolean, returnBook: any, renewLoan: any }> = (props) => {
    return(
        ...
        `modal${props.shelfCurrentLoan.book.id}`} data-bs-keyboard="false" aria-labelledby="statcBackdropLabel"
                                ...
                                <div className="row">
                                    <div className="col-2">
                                        {props.shelfCurrentLoan.book?.img ?
                                            ...
                                            :
                                            <img src={require('./../../../Images/BooksImages/book-luv2code-1000.png')} width="56" 
                                            height="87" alt="Book" />  
                                        }
                                    </div>
