    ...
    return (
        <div className="card mt-3">
            <div className="card-header">
                Ask question to the library admin
            </div>
            <div className="card-body">
                <form method="POST">
                    ...
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="exampleFormControl1"
                    ...
                    <div>
                        <button type="button" className="btn btn-primary" onClick={submitNewQuestion}>
                            Submit Question
                        </button>
                    </div>
                </form>
